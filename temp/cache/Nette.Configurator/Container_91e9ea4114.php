<?php
// source: C:\Users\Vitalij Motrja\Desktop\Web\kct-hlinsko\app/config/config.neon 
// source: C:\Users\Vitalij Motrja\Desktop\Web\kct-hlinsko\app/config/config.local.neon 

class Container_91e9ea4114 extends Nette\DI\Container
{
	protected $meta = array(
		'types' => array(
			...
			'App\Presenters\ActivitiesPlansPresenter' => array(array('application.1')),
		...
		'services' => array(
			...
			'application.1' => 'App\Presenters\ActivitiesPlansPresenter',
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => 'C:\Users\Vitalij Motrja\Desktop\Web\kct-hlinsko\app',
			'wwwDir' => 'C:\Users\Vitalij Motrja\Desktop\Web\kct-hlinsko\www',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'environment' => 'development',
			'consoleMode' => FALSE,
			'container' => array('class' => NULL, 'parent' => NULL),
			'tempDir' => 'C:\Users\Vitalij Motrja\Desktop\Web\kct-hlinsko\app/../temp',
		));
	}
	...
	/**
	 * @return App\Presenters\ActivitiesPlansPresenter
	 */
	public function createServiceApplication__1()
	{
		$service = new App\Presenters\ActivitiesPlansPresenter;
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'C:\Users\Vitalij Motrja\Desktop\Web\kct-hlinsko\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('C:\Users\Vitalij Motrja\Desktop\Web\kct-hlinsko\app/../temp');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\Users\Vitalij Motrja\Desktop\Web\kct-hlinsko\app/../temp/cache',
	...
	{
		return new Container_91e9ea4114_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
	...
	public function createServiceNette__latte()
	{
		...
		trigger_error('Service nette.latte is deprecated, implement Nette\Bridges\ApplicationLatte\ILatteFactory.',
			16384);
		$service->setTempDirectory('C:\Users\Vitalij Motrja\Desktop\Web\kct-hlinsko\app/../temp/cache/latte');
...
final class Container_91e9ea4114_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_91e9ea4114 $container)
	{
